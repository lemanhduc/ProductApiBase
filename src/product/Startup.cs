    ...
    public class Startup {
        ...
        public void ConfigureServices (IServiceCollection services) {
            ...
            Action<MySqlDbContextOptionsBuilder> mySqlOptionsAction = (o) => {
                ...
                o.EnableRetryOnFailure (maxRetryCount: 5, maxRetryDelay: TimeSpan.FromSeconds (30), errorNumbersToAdd: null);
            };

            services.AddDbContext<ProductDBContext> (
                options => options.UseMySql (Configuration, mySqlOptionsAction)
            );
